...
export default function Page() {
  return (
    <div className="flex w-full h-screen">
      ...
      <div className="bg-primary md:w-[40%] w-full min-w-fit flex flex-col gap-8 justify-center items-center">
        <h1 className="text-white font-bold text-4xl">Login to Mentra</h1>
        <SignIn/></div>
    </div>
  )
}